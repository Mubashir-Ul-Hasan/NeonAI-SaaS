...
const benefits = [
  {
    title: "Start with free AI tools",
    description:
      "Use article writing and blog title generation before upgrading to premium.",
    icon: Gift,
  },
  {
  ...
  },
  {
    ...
    description:
      "Every generated result will later be saved to your personal dashboard history.",
    icon: BrainCircuit,
  },
];
      ...
      <div className="grid min-h-screen lg:grid-cols-[1fr_0.95fr]">
        <section className="relative hidden border-r border-slate-200/70 px-8 py-8 dark:border-white/10 lg:flex lg:flex-col">
          ...
          <div className="flex flex-1 items-center">
            <div className="mx-auto max-w-xl">
              ...
              <p className="mt-6 text-lg leading-8 text-slate-600 dark:text-slate-300">
                Create an account to access the dashboard, use free AI tools,
                save generated content, and upgrade to premium features later.
              </p>
          ...
          <div className="grid grid-cols-3 gap-3">
            {["Free start", "Secure auth", "Premium ready"].map((item) => (
              <div
                key={item}
            ...
            <div className="relative overflow-hidden rounded-[2.5rem] border border-slate-200 bg-white/80 p-4 shadow-2xl shadow-slate-950/10 backdrop-blur-2xl dark:border-white/10 dark:bg-white/[0.05]">
              ...
              <div className="relative mb-5 px-3 pt-3 text-center">
                ...
                <p className="mt-2 text-sm leading-6 text-slate-500 dark:text-slate-400">
                  Sign up with Google or verify your email with a secure code.
                </p>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs leading-5 text-slate-500 dark:text-slate-400">
                    New users start on the Free plan. Premium tools will unlock
                    after successful billing integration.
                  </p>
                </div>
              </div>
            </div>
